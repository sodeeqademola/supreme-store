...
const AllProducts = ({ products }: PropductsProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="text-3xl tracking-[5px] text-center">
        <span className="text-[#249ea7] text-5xl font-semibold">A</span>ll{" "}
        <span className="text-[#249ea7] text-5xl font-semibold">P</span>roducts
      </div>
      <div className="flex justify-center gap-3 items-center flex-wrap">
        {products.length > 0 ? (
          products.map((products, index: number) => {
