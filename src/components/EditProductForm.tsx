...
import { updateProduct } from "@/Action/paymentIntent";
...
type EditedProductProps = {
  editedProduct: {
    ...
    category: string;
    inStock: boolean;
    images: { color: string; colorCode: string | null; image: string }[];
  } | null;
};

const EditProductForm = ({ editedProduct }: EditedProductProps) => {
    ...
    >
      ...
      >
        ...
        <Input
          ...
          defaultValue={editedProduct?.price.toString()}
        />
        <Input
          type="text"
          label="Brand"
        ...
        <Checkbox
          ...
          defaultChecked={editedProduct?.inStock}
        >
        ...
        <div className="my-4">
          <EditImageUpload
            ...
            previousImage={editedProduct?.images.map((image) => {
              return image.image;
            })}
          />
        </div>
